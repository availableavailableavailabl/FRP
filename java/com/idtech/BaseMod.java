...
import com.idtech.world.ConFiguredFeatures;
...
public class BaseMod {
    ...
    public BaseMod(RegistryEvent.Register<Item> event) {
...
//            event.getRegistry().register(BlockMod.CASTLE_WALL);
         ...
         */
        @SubscribeEvent
        public static void registerItems(final IEventBus eventBus, RegistryEvent.Register<Item> event) {
         ...
         */
        @SubscribeEvent
        public static void registerEntities(final RegistryEvent.Register<Item> event) {
